...
describe('zipfile', function() {
	it('should be under /Users/jofo/git/o2klBanners/o2kl-TIAA-BannerAds/4224-4225-IAS-DIS/BigPicture/300x600/node_modules/.bin/resize-bannekb', function() {

		var zip = fs.statSync('Zelis-1.zip');
...
describe('built package', function() {
	...
	it('should have no http calls', function(){
		expect(count(html, "http://")).toBe(0, '\nPlease remove any "http://" calls from the html file. Relative protocols should work, or use "http://"');
	});
