...
(function () {
	...
	nameSpace.init = function () {
		...
		TweenMax.set(['#hero', '#copy-1', '#copy-2'], { autoAlpha: 0 });
		TweenMax.set(['#copy-1', '#copy-2'], { x: -width });
		// TweenMax.set('#logo', { scale: 1.75, transfromOrigin: 'center center' });
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			.to('#sign', 0.5, { scale: 0.5, transfromOrigin: 'center center', x: -60, y: -81 }, '+=2')
			...
			.to('#copy-1', 0.5, { autoAlpha: 0, x: width, z: 0.01, transformPerspective: 400, rotationZ: 0.01, force3D: true }, "+=3.1")
