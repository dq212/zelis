...
(function () {
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			.to('#sign', 0.5, { scale: 0.55, transfromOrigin: 'center center', x: -70, y: -91 }, '+=2')
			.to('#copy-1', 0.8, { autoAlpha: 1, x: 0, z: 0.01, transformPerspective: 400, rotationZ: 0.01, force3D: true })

			.to('#copy-1', 0.5, { autoAlpha: 0, x: width, z: 0.01, transformPerspective: 400, rotationZ: 0.01, force3D: true }, "+=2")
			.to(['#copy-2', '#hero'], 0.5, { z: 0.01, transformPerspective: 400, rotationZ: 0.01, force3D: true, autoAlpha: 1, x: 0 })
